function Image_Cropper_(env) {
    ...
    this.vueModules = {
        base: [
            ...
            {
                name: "AppStepper",
                location: "client/src/components/base/AppStepper",
                get file () {
                    return HtmlService
                    .createTemplateFromFile(this.location)
                    .getRawContent();
        ...
        view: [
            ...
            {
                name: "ImageCropperIndex",
                location: "client/src/components/image-cropper/Index",
                get file () {
                    return HtmlService
                    .createTemplateFromFile(this.location)
                    .getRawContent();
            ...
            {
                name: "ImageCropperSectionTwo",
                location: "client/src/components/image-cropper/SectionTwo",
                get file () {
                    return HtmlService
                    .createTemplateFromFile(this.location)
                    .getRawContent();
    ...
    this.cssLibraries = [
        ...
        {
            name: "CropperCss",
            location: "client/src/libraries/Cropper",
            get file () {
                return HtmlService
                .createTemplateFromFile(this.location)
                .getRawContent();
    ...
    this.jsLibraries = [
        {
            name: "popperjs-core-v2.5.4-js",
            location: "client/src/libraries/popperjs-core-v2.5.4",
            get file () {
                return HtmlService
                .createTemplateFromFile(this.location)
                .getRawContent();
    ...
    this.vueStoreModules = [
        ...
        },
        {
            ...
            objectInitialisation: "imageCropper: imageCropperModule",
            location: "client/src/store/modules/imageCropperModule",
            get file () {
                return HtmlService
                .createTemplateFromFile(this.location)
                .getRawContent();
    ...
    this.vueCoreMainJs = [
        {
            name: "router",
            location: "client/src/router/imageCropperRouter",
            get file () {
                return HtmlService
                .createTemplateFromFile(this.location)
                .getRawContent();
